...
<div class="container-fluid">
  <div class="row flex-nowrap">
    ...
    <div class="col py-4 px-4">
      <!-- MOBILE sidebar toggle/offcanvas (navbar) -->
      <?php // Include just the offcanvas code for mobile here if not present elsewhere ?>
        ...
        fetch(`fetch_chat.php?since=${lastTimestamp}`)
            ...
            .then(data => {
                if (Array.isArray(data) && data.length > 0) {
                    ...
                    if (didAppend) {
                        chatPing.play().catch(err => { console.warn('Sound blocked or failed:', err); });
